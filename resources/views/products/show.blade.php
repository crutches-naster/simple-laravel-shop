<x-app-layout>
    ...
    <section class="text-gray-700 body-font overflow-hidden bg-white product-page">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex align-items-center justify-between">
                        <div class="flex items-center justify-start w-60">
                            @if($product->base_price !== $product->endPrice)
                                <span class="title-font font-medium text-2xl line-through text-red-400 mr-5">${{ $product->base_price }}</span>
                            @endif
                    ...
                    <form action="{{ route('cart.add', $product) }}" class="flex align-items-center justify-end w-full"
                        ...
                        <div class="custom-number-input w-70 flex items-end justify-content-end">
                            ...
                            <button type="submit"
                                    class="ml-5 h-10 ml-auto w-full text-center text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded disabled">
                                Add to cart
                            </button>
                        </div>
                    </form>
        ...
        @if ( count($product->images))
            ...
            <div class="container px-5 py-12 mx-auto">
                <h3 class="mb-10 text-center text-2xl font-bold">Additional images</h3>
